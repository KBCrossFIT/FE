                ...
                <form @submit.prevent="handleSubmit" class="signup-form">
                    ...
                    <div class="form-group">
                        ...
                        <input
                            ...
                            required
                        />
                        <p v-if="errors.memberID" class="error-message">
                            {{ errors.memberID }}
                        </p>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input
                            ...
                            required
                        />
                        <p v-if="errors.reEnteredPassword" class="error-message">
...
/* 비밀번호 입력 시의 글꼴 지정 */
input[type='password'] {
    font-family: 'PasswordFont', sans-serif; /* 비밀번호 필드의 텍스트 폰트 */
}

/* 비밀번호 입력 필드의 placeholder에만 'BMDOHYEON' 폰트 지정 */
