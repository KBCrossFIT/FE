<template>
  <v-container fluid>
    <v-row justify="center" align="center">
      ...
      <v-col cols="6" md="3" lg="2">
        <v-btn color="teal" block @click="navigateTo('/my-investment-analyze')">투자성향분석</v-btn>
      </v-col>
      <v-col cols="6" md="3" lg="2">
        <v-btn color="teal" block @click="navigateTo('/login')">로그인</v-btn>
      </v-col>
      <v-col cols="6" md="3" lg="2">
        <v-btn color="teal" block @click="navigateTo('/signup')">회원가입</v-btn>
      </v-col>
      <v-col cols="6" md="3" lg="2">
        <v-btn color="teal" block @click="navigateTo('/mypage')">개인정보</v-btn>
      </v-col>
      <v-col cols="6" md="3" lg="2">
        <v-btn color="teal" block @click="navigateTo('/product-comparison')">상품 비교</v-btn>
      </v-col>
      <v-col cols="6" md="3" lg="2">
        <v-btn color="teal" block @click="navigateTo('/financial-products')">금융상품</v-btn>
      </v-col>
      <v-col cols="6" md="3" lg="2">
      ...
      <v-col cols="6" md="3" lg="2">
        <v-btn color="teal" block @click="navigateTo('/funds')">펀 리스트</v-btn>
      </v-col>
      <v-col cols="6" md="3" lg="2">
        <v-btn color="teal" block @click="navigateTo('/stocks')">주식 리스트</v-btn>
      </v-col>
      <v-col cols="6" md="3" lg="2">
        <v-btn color="teal" block @click="navigateTo('/stock-search')">주식 검색</v-btn>
      </v-col>
    </v-row>
  </v-container>
</template>
