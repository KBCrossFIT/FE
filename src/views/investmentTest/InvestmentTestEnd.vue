    ...
    <div class="InvestmentTest-body">
      <div class="InvestmentTest-content">
        <div class="InvestmentTest-text">
          ...
          예정이며 우리은행에 의하여 기밀로 보호될 것을 약속드립니다. 다음 화면에서 제공되는 투자자성향 분석 결과는
          고객님께서 제공하신 정보를 바탕으로 분석되었으며, 거래목적, 투자기간·기대이익·기대손실을 고려한 위험에 대한
          태도, 금융상품에 대한 이해도, 재산상황, 투자성상품의 취득·처분 경험, 연령 등에 비추어 적합하지 않은 상품은
          투자권유가 불가합니다. 본인은 투자위험에 대한 본인의 성향이 올바르게 선택되어 있음을 확인합니다.
        </div>

        <!-- 총 점수와 투자 성향 결과 -->
        <div class="InvestmentTest-result">
